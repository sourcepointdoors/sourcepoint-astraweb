...
export function elementPage(mediaUrl = '') {
  const features = [
    [
      '01',
      'More glass. More possibility.',
      'Slim aluminum profiles',
      'A minimalist frame puts the glass—and the view—at the center of the opening.',
      'Extruded aluminum',
    ],
    [
      '02',
      'Let the room open outward.',
      'Side-stacking panels',
      'Folding panels stack to the side to connect interior and exterior spaces. Top and bottom rollers support smooth operation.',
      'Top + bottom rollers',
    ],
    [
      '03',
      'Comfort is in the construction.',
      'Thermal break + insulated glazing',
      'A thermally broken frame helps reduce heat transfer. Double-tempered Low-E glass with argon supports year-round insulation.',
      'Low-E · Argon filled',
    ],
    [
      '04',
      ...
      'Concealed hardware',
      'Concealed hardware keeps the focus on the door’s slim lines and glass. Handles are included with the door system.',
      'Handles included',
    ],
    [
      '05',
      'Considered down to the seal.',
      'Drainage, gaskets & seals',
      'Upgraded drainage, gaskets, and rubber strips help resist air and water intrusion at the opening.',
    ...
    [
      ...
      'Multi-point locking',
      'The multi-point automatic locking system secures the door at multiple points when closed.',
      'Multi-point automatic',
    ],
  ];
  const specs = [
    ['Frame & door', 'Extruded aluminum'],
    ['Frame construction', 'Thermally broken'],
    ['Finish', 'Powder-coated'],
    ['Operation', 'Folding to exterior'],
    ['Roller system', 'Top + bottom rollers'],
    ['Glazing', 'Double-tempered, Low-E, argon filled'],
    ['Thickness', '2¾ inches'],
    ['Supply format', 'Pre-hung'],
    ['Handles', 'Included'],
 ...
 <section class="element-sizes section" id="element-sizes"><div class="section-heading"><div><span class="eyebrow">Fit the opening</span><h2>Your space.<br>Your configuration.</h2></div><p>Stock size options in two heights.<br>Special-order sizes and configurations on request.</p></div><p class="element-size-note">All dimensions shown in inches.</p><div class="element-table-wrap"><table><caption>Element folding door stock size options</caption><thead><tr><th scope="col">Width × height</th><th scope="col">Panels</th><th scope="col">Configurations</th><th scope="col">Operation</th></tr></thead><tbody>${[
   ...
   .join(
     '',
   )}</tbody></table></div><p class="element-size-note">Stock size listing does not indicate live inventory. Confirm configuration and availability with your dealer before ordering.</p></section>
 <section class="element-specs section" id="element-specs"><div><span class="eyebrow">The details, specified</span><h2>Engineered<br>into every opening.</h2><p>Product specifications for the Element aluminum folding door.</p><a class="button" href="/assets/documents/element-spec-sheet.pdf" target="_blank" rel="noopener">View specification sheet <span aria-hidden="true">${icon('external')}</span></a><div class="element-finishes"><h3>Available finishes</h3><span><i class="finish-black" aria-hidden="true"></i>Matte black</span><span><i class="finish-white" aria-hidden="true"></i>White</span></div></div><dl>${specs.map(([a, b]) => `<div><dt>${a}</dt><dd>${b}</dd></div>`).join('')}</dl></section>
 <section class="cta"><div><span class="eyebrow">Bring Element to your next project</span><h2>Start with<br>the right opening.</h2></div><a class="button" href="tel:18888213776">Talk to SourcePoint <span aria-hidden="true">${icon('external')}</span></a></section>`;
}
